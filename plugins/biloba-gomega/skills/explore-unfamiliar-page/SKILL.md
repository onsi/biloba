...
- If the flow is occlusion-, hover-, or drag-sensitive, the fast track may pass where a real user would be blocked. Add a focused smoke test on the realistic track (`b.Realistic()`, `Label("realistic")`) → `realistic-mode`.
